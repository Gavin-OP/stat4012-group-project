...
if __name__ == "__main__":
    ...
    predicted_return = pd.read_csv('/Users/zhangpuming/Desktop/stat4012 project/backtrader/model/cnn_model3_seed11_epochs100_days5_stride1_diffFalse_classification_good.csv', header=None)
