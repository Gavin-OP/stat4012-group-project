...
raw.data.normalized <- cbind(raw.data.normalized, dataset[, c('golden_cross', 'death_cross')])
...
## Method 2: PCA based on normalized raw data diff
...
## Method 3: PCA based on normalized data
```{r}
...
## Method 4: PCA based on correlation of normalized data
```{r}
